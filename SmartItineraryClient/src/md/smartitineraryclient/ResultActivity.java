...
public class ResultActivity extends Activity {
	...
	// TODO: set the ip of your *server* host
		...
		private void updateItineraryList(List<Map<String, String>> listItem) {
			List<Map<String, String>> rows = listItem;		
			// POI ListView
			...
			itineraryListView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
					Intent myIntent = new Intent(view.getContext(), SelectedItineraryActivity.class);
					startActivityForResult(myIntent, 0);
				}
			});
			ListAdapter itineraryAdapter = new SimpleAdapter(this, rows,
